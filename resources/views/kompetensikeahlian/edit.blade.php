...
id="kdstandkomp" value="{{$jurusan->fstandkomp->id ?? old('kdstandkomp')}}">
                                <input type="text" class="form-control
@error('standarkompetensi') is-invalid @enderror" placeholder="Standar Kompetensi"
id="standarkompetensi" name="standarkompetensi" value="{{$jurusan->fstandkomp->standarkompetensi ?? old('standarkompetensi')}}" aria-label="Standar Kompetensi" aria-describedby="cari" readonly>
                                <button class="btn btn-warning" type="button"
data-bs-toggle="modal" id="cari" data-bs-target="#staticBackdrop"></i> Cari Data Standar Kompetensi</button>
                              </div>
                            </div>
                        </div>
